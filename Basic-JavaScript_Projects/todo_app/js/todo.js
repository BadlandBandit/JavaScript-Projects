...
function show() {
    ...
    /*This adds the remove function to each "x" button*/
...
function remove() {
    ...
    var todos = get_todos();
    /*This removes the task from the array based on the id*/
    todos.splice(id, 1);
    /*This updates the task in the web browser memory after the task is removed*/
    localStorage.setItem('todo', JSON.stringify(todos));
    /*This keeps the remaining tasks permanently displayed on the screen*/
    show();
